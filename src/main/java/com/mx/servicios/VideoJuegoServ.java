...
import com.mx.dao.VideoJuegoDao;

import com.mx.entidad.VideoJuego;
import com.mx.general.Estatus;

@Path("VideoJuego")
public class VideoJuegoServ {
VideoJuegoDao dao = null;
	...
	public List<VideoJuego> mostrar() {
		...
		List<VideoJuego>lista = dao.mostrar();
		return lista;
	}
	...
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces({MediaType.APPLICATION_JSON})
	public Estatus guardar(VideoJuego e) {
	...
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces({MediaType.APPLICATION_JSON})
	public Estatus eliminar(VideoJuego e) {
		Estatus estatus = new Estatus();
		
		dao = new VideoJuegoDao();
		e=(VideoJuego) dao.buscar(e);
		estatus.setObjecto(e);
	...
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces({MediaType.APPLICATION_JSON})
	public Estatus editar(VideoJuego e) {
		Estatus estatus = new Estatus();
	...
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces({MediaType.APPLICATION_JSON})
	public VideoJuego buscar(VideoJuego e) {
		dao = new VideoJuegoDao();
		e = (VideoJuego)dao.buscar(e);
		return e;
	}
